...
export default function GrenadeDetails({ grenade, active, ...props }) {
        ...
        {grenade &&
            <>
                ...
                <div className={css`
                    ...
                    overflow: hidden;
                `}>
                    {grenade.offensiveRange.map((el, i) => <div key={i} className={css`
                        width: 100%;
                        height: ${el * 100}%;
                ...
                <div className={css`
                    ...
                    overflow: hidden;
                `}>
                    {grenade.coverage.map((el, i) => <div key={i} className={css`
                        width: 100%;
                        height: ${el * 100}%;
                        align-self: center;
                        background: ${el > 1 ? colors.gold : 'white'};
